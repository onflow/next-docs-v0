...
async function getContent() {
  const response = await octokit.graphql(`
    ...
    query {
      docs: repository(owner: "onflow", name: "flow-js-sdk") {
        ... on Repository {
      ...
      readme: repository(owner: "onflow", name: "flow-js-sdk") {
        ... on Repository {
  ...
  fs.writeFileSync(path.resolve(__dirname, "../flow-js-docs.json"), data);
}
